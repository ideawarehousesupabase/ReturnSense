    ...
    <div className="grid min-h-screen place-items-center bg-secondary/40 px-4">
      <Card className="w-full max-w-md p-8">
        ...
        <form onSubmit={submit} className="mt-6 space-y-4">
          ...
          <div><Label htmlFor="p">New password</Label><Input id="p" type="password" required value={pw} onChange={(e) => setPw(e.target.value)} className="mt-1" /></div>
          <div><Label htmlFor="c">Confirm new password</Label><Input id="c" type="password" required value={cf} onChange={(e) => setCf(e.target.value)} className="mt-1" /></div>
